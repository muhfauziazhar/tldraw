	...
	return (
		...
		>
			...
			{/* The host for <EditorPortal>, last among the container's children so that anything
			    ...
			    content" link in the tab order, which only works while nothing precedes it. It's a
			    position in the DOM rather than a box: `display: contents` keeps what it holds
			    positioned against the container. */}
			<div className="tl-portal-host" style={{ display: 'contents' }} ref={setPortalHost} />
		</div>
	)
})
